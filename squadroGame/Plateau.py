...
class Plateau:
    ...
    def affichage(self, jEnCours, moutons = False):
        if moutons: return self.affichageMoutons(jEnCours)
    ...
    def affichageMoutons(self, jEnCours):
        cote = 70
        ...
        fondPlateau = Image.open("graphics/fond.png").convert("RGBA").resize((cote * 7, cote * 7))
