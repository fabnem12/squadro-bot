...
listeScripts = ["pythonBot/pythonbot.py", "pythonBot/votenew.py", "discordUtils/ranks.py", "discordUtils/ranks2.py", "squadroGame/bot.py", "discordUtils/discordutils.py", "squadroGame/botNew.py", "voltBot/bump_leaderboard.py", "pythonBot/edtbot.py", "voltBot/photo_contest.py"]
